...
router.put("/:id", userExtractor, upload.single("image"), async (req, res) => {
  try {
    ...
    if (isAudioScreen) {
      if (image === "/blank.png" || image === "/blank-white.png" || image === "/blank-indigo.png") {
        return res.status(400).json({ 
      ...
      id,
      {
        $push: {
          cues: {
            ...
            file: {
              id: fileId,
              name: file && file.originalname ? file.originalname : (image === "/blank-white.png" ? "blank-white.png" : image === "/blank-indigo.png" ? "blank-indigo.png" : "blank.png"),
              url: (image === "/blank.png" || image === "/blank-white.png" || image === "/blank-indigo.png") ? null : "",
              ...(driveId && { driveId }),
            },
            loop: loop,
          },
  ...
  async (req, res) => {
    try {
      ...
      if (image === "/blank.png" || image === "/blank-white.png" || image === "/blank-indigo.png") {
        ...
        cue.file = {
          id: newFileId,
          name: image === "/blank-white.png" ? "blank-white.png" : image === "/blank-indigo.png" ? "blank-indigo.png" : "blank.png",
          url: null,
          type: "image/png",
        }
      }
