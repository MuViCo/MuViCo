...
const TermsPage = () => (
  ...
  >
    ...
    <p>
      Welcome to MuViCo! These Terms and Conditions ("Terms") govern your access
      to and use of MuViCo website and services ("Services"), so please read
      them carefully before using the Services. By accessing or using the
    ...
    <p>
      By using the Services, you agree to abide by these Terms and any other
      policies or guidelines incorporated by reference herein. These Terms
      constitute the entire agreement between you and MuViCo regarding the use
      of the Services.
    </p>

    <h4>User Registration:</h4>
    <p>
      In order to access certain features of the Services, you may be required
    ...
    <h4>User Content:</h4>
    <p>
      You may have the opportunity to submit, upload, or post content, including
      but not limited to text, images, videos, and audio ("User Content"), to
      the Services. By submitting User Content, you grant MuViCo a worldwide,
    ...
    <p>
      MuViCo respects the intellectual property rights of others and expects
    ...
    <p>
      ...
      with these Terms. You further agree not to:
    </p>
    <ul>
      <li>
        Upload, post, or transmit any User Content that is unlawful, harmful,
    ...
    <p>
      To the fullest extent permitted by law, MuViCo shall not be liable for any
    ...
    <p>
      You agree to indemnify and hold harmless MuViCo and its affiliates,
      officers, directors, employees, and agents from and against any and all
      claims, liabilities, damages, losses, costs, expenses, or fees (including
    ...
    <p>
      MuViCo reserves the right to modify or amend these Terms at any time
      without prior notice. Any changes to the Terms will be effective
      immediately upon posting. Your continued use of the Services following the
    ...
    <p>
      ...
      of EU, without regard to its conflict of law principles.
    </p>
    ...
    <p>
      ...
      agree to be bound by these Terms and any other policies or guidelines
      incorporated by reference herein. If you do not agree to these Terms,
