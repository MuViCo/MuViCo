export const editModeFeaturesData = [
  {
    ...
    items: [
      ...
      "Storage indicator: Displays how much space has been used. By default, the maximum allowed space is 50 MB.",
      "Transition type selector: Use this dropdown to select the type of transition between presentation frames.",
      "Pencil icon next to the presentation name: Click this button to edit the name of your presentation.",
