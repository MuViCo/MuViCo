...
(What does that mean? View the manual from the help page button for more details!)` },
    ...
    { id: "presentation-size-info", selector: "#screen_preview", title: "Screens Preview",
    description: "This area shows a preview of each screen in your presentation." },
    { id: "transition-type-select", selector: "#transition-type-select", title: "Transition Type Selector",
    description: "Use this dropdown to select the type of transition between presentation frames." },
    { id: "edit-presentation-name-button", selector: "#edit-presentation-name-button", title: "Edit Presentation Name",
